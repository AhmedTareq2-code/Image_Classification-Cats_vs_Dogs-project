...
A Convolutional Neural Network that classifies photos as either a cat or a dog — built as a final capstone project for an ML internship, with a live Streamlit demo for real-time predictions on new images.
